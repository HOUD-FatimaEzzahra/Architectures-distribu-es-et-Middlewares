 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://enset.ma/", wsdlLocation = "http://localhost:8087/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://enset.ma/", "BanqueWS");
